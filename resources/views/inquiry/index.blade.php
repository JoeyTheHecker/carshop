        ...
        <div class="panel" style="box-shadow: 0 0px 0;">
            <div class="panel-body grey-bgcolor">
                ...
                <div id="newSubmissions" class="tab-pane active">
                    <form id="search" data-id="1" class="form-inline" data-action="{{ url('/inquiry/summary') }}">
                        {{-- <div class="panel-body" style="padding: 10px 0px;">
                            ...
                            <div class="row row-pad-5">
                                ...
                                <div class="col-md-3 col-lg-2">
                                    <button type="button" class="btn btn-primary download-btn1" style="height: 39px; width: 100%;" data-action="{{ url('/web/inquiry/download') }}">Download Excel</button>
                                </div>
                            </div>
                        </div> --}}
